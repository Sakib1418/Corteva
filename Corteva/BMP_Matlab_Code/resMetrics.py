def [ resdata ] = resMetrics( resdata, currentYear, seedPop, ...
...
R = sumResistant(seedPop(currentYear, :, ),key) #resistant population
T = sum(seedPop(currentYear, :, ),2)    #total population (at  of year)
